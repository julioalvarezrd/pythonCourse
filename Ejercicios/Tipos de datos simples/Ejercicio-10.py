...
# que saldrán en cada paquete a demanda. Cada payaso pesa
# 112 g y cada muñeca 75 g. Escribir un programa que lea
# el número de payasos y muñecas vendidos en el último
